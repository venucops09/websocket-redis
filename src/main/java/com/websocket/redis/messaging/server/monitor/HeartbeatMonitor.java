...
public class HeartbeatMonitor {
    ...
    @Value("${app.websocket.heartbeat.check-rate}")
    private long heartbeatCheckRate;

    @Scheduled(fixedRateString = "${app.websocket.heartbeat.check-rate}") // configured in properties
